...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="纪言",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6纪言11AppDelegate")
...
SWIFT_CLASS("_TtC6纪言13SceneDelegate")
...
SWIFT_CLASS("_TtC6纪言11recordsound")
@interface recordsound : UIViewController
